<template>
  <div class="fe-month-data-picker">
    <el-form-item
    ...
    >
      <el-date-picker
        ...
        class="fe-month-data-picker-input-content"
      >
      </el-date-picker>
      <!--<div-->
...
<script>
  ...
  export default {
    ...
    methods: {
      setDefaultValue(val) {
        const startDate = moment(val).format(this.format)
        const endDate = moment(val).add('months', 1).date(0).format(this.format)
...
<style rel="stylesheet/scss" lang="scss">
  .fe-month-data-picker {
    ...
    .fe-month-data-picker-input-content {
      width: 178px;
    }
